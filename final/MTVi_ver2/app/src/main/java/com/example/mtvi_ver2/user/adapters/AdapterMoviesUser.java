...
public class AdapterMoviesUser extends RecyclerView.Adapter<AdapterMoviesUser.MoviesUserViewHolder> implements Filterable  {
    ...
    public AdapterMoviesUser(Context mContext, ArrayList<DataMovies> mDataMovies, InterfaceClickItemMovies mListener) {
