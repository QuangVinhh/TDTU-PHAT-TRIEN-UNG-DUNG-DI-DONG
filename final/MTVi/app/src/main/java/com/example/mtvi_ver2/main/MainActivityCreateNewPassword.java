...
public class MainActivityCreateNewPassword extends AppCompatActivity {
    ...
    String get_intent_email_verify;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get_intent_email_verify = intent.getStringExtra("email_verify");
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(new_password_value)) {
                    ...
                    if(TextUtils.isEmpty(account_name)){
                        if(AccountsDAO.updatePassword(MainActivityCreateNewPassword.this, get_intent_email_verify, new_password_value)){
                            Toast.makeText(MainActivityCreateNewPassword.this, "UPDATE ACCOUNT SUCCESSFULLY", Toast.LENGTH_SHORT).show();
                            dataAccounts.clear();
                            ...
                            Toast.makeText(MainActivityCreateNewPassword.this, "UPDATE ACCOUNT FAILED", Toast.LENGTH_SHORT).show();
                        }
                    } else {
