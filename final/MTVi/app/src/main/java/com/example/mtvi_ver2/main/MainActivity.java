...
public class MainActivity extends AppCompatActivity {
    ...
    private void EventButtonSignIn() {
        main_login_button_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean checkAccounts = AccountsDAO.checkAccounts(MainActivity.this, email_value, password_value);
                ...
                if(TextUtils.isEmpty(email_value)) {
                    ...
                    accounts = new DataAccounts(-1, "", email_value, "", "");
    ...
    private void EventRecoverPassword() {
        main_login_button_recover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String email_value = main_login_email.getText().toString();
                boolean checkAccounts = AccountsDAO.checkEmail(MainActivity.this, email_value);
                ...
                if(TextUtils.isEmpty(email_value)) {
                    ...
                    Intent intent = new Intent(MainActivity.this, MainActivityCreateNewPassword.class);
                    intent.putExtra("email_verify",email_value);
                    startActivity(intent);
                } else {
                    main_login_email.requestFocus();
                    main_login_email.setError("Your email is unregistered !");
                }
            }
        });
    }
